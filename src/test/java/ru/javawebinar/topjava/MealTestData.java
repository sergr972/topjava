...
public class MealTestData {
    ...
    public static final Meal adminMeal1 = new Meal(ADMIN_MEAL_ID, of(2020, Month.JANUARY, 31, 14, 0), "Админ ланч", 500);
    ...
    public static Meal getNew() {
        return new Meal(null, LocalDateTime.of(2020, Month.JANUARY, 31, 21, 0), " Новый Ужин", 410);
    }

    public static Meal getUpdated() {
        return new Meal(ADMIN_MEAL_ID, adminMeal1.getDateTime().plus(1, ChronoUnit.MINUTES), "Админ ланч измененный.", 2000);
    }
